...
import HaveLogo from "../public/images/havenlogo.png"
import Image from "next/image"

export default function Footer() {
  return (
    <footer className="bg-black dark:bg-white-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-white-600 dark:text-white-400 font-medium">
                <li className="mb-4">
                  <a
                    href="https://github.com/themesberg/HavenSwap"
                    className="hover:underline "
                  >
                    Github
                  </a>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white-500 sm:text-center dark:text-white-400">
            © 2023{"{"}" "{"}"}
            <a href="https://HavenSwap.com/" className="hover:underline">
              HavenSwap™
            </a>
            . All Rights Reserved.
          </span>
